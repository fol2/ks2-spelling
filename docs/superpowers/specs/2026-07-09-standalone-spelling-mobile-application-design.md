...
rights are recorded. Production audio is delivered as signed pack data,
verified during installation and then played from local storage. Once the
required pack is installed, spelling practice and replay must work without a
network connection.
