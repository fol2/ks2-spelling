...
| `help.eugnel.uk` live | `https://help.eugnel.uk/` and `https://help.eugnel.uk/privacy` return the single-sourced pages ([#139](https://github.com/fol2/ks2-spelling/issues/139) / [#172](https://github.com/fol2/ks2-spelling/issues/172)). Apple version-gates both URLs. |
